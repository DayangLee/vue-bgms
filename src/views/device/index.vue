...
<div class="data-container">
    ...
    <el-tab-pane label="设备状态" name="first">
      ...
      <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column prop="status" label="运行状态" width="100" align="center">
          <template scope="scope">
            <el-tag
          :type="scope.row.status === '运行中' ? 'success' : 'danger'">{{scope.row.status}}</el-tag>
      </template>
        </el-table-column>
        <el-table-column prop="time" label="定时" width="150" align="center">
        </el-table-column>
       ...
       <el-button type="success"
         size="small"
         @click="handleDetail(scope.$index, scope.row.deviceId)">详情</el-button>
       <el-button
         size="small"
         type="primary"
         @click="handleEdit(scope.$index, scope.row.deviceId)">操作</el-button>
     </template>
        </el-table-column>
      </el-table>
  ...
  <el-dialog id="detailDialog" title="汉王大厦" size='large' v-model="dialogTableVisible">
        ...
        <el-card class="box-card information">
          ...
          <div class="card-body">
            <div class="thisDevId informationItem">
              <div><img src="../../assets/deviceManage/id.png" /></div>
            ...
            <div class="thisDevTime informationItem">
              <div><img src="../../assets/deviceManage/time.png" /></div>
            ...
            <div class="thisDevUser informationItem">
              <div><img src="../../assets/deviceManage/user.png" /></div>
            ...
            <div class="thisDevLocation informationItem">
              <div><img src="../../assets/deviceManage/location.png" /></div>
            ...
            <div class="thisDevGroup informationItem">
              <div><img src="../../assets/deviceManage/group.png" /></div>
            ...
            <div class="thisDevContact informationItem">
              <div><img src="../../assets/deviceManage/contact.png" /></div>
            ...
            <div class="thisDevTel informationItem">
              <div><img src="../../assets/deviceManage/phone.png" /></div>
    ...
    <el-card class="newWind">
      <div class="left">
        <img src="../../assets/deviceManage/newWind.png" />
      </div>
      <div class="right">
        <div class="rightUp">
    ...
    <el-card class="history">
      ...
      <div class="components-container">
        ...
        <div class="chooseDataType">
          <div>检测项目</div>
          <el-button>PM2.5<img src="../../assets/deviceManage/gray.png" /></el-button>
          <div class="clear"></div>
          <el-button>CO2<img src="../../assets/deviceManage/green.png" /></el-button>
          <div class="clear"></div>
          <el-button>甲醛<img src="../../assets/deviceManage/yellow.png" /></el-button>
          <div class="clear"></div>
          <el-button>温度<img src="../../assets/deviceManage/purple.png" /></el-button>
          <div class="clear"></div>
          <el-button>湿度<img src="../../assets/deviceManage/blue.png" /></el-button>
        </div>
      </div>
    </el-card>
  </el-dialog>
      ...
      margin-bottom: 5%;
        ...
        .card-body {
            ...
            .dataNum {
                ...
                .choData, .co2Data, .tempData, .wetData {
                    z-index: 999;
                    height: 10px;
                    position: absolute;
                    left: 0;
