  ...
  <div class="data-container">
    ...
    <el-collapse accordion class="personalCollapse">
        ...
        <div class="details">
          <el-form label-width="80px" :model="ruleForm1">
            ...
            <el-form-item style="text-align:center;">
              <el-button type="primary" size="large" style="width:150px;" @click="submitInformationForm('ruleForm1')">提交</el-button>
            </el-form-item>
          </el-form>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item>
        ...
        <div class="details">
          <p>当前邮箱：dayanglee2015@163.com</p>
      ...
      <el-collapse-item>
        <template slot="title" class="info-title">
          ...
          <div class="content">{{user.password | passwordDeal}}</div>
          <div class="edit">编辑</div>
        </template>
        <div class="details">
